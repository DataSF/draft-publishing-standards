...
| Unit | Numeric | The unit number, for example if the address refers to an apartment; e.g 315 Main Street, Apt 2; 2 is the Unit | There is no complete reference of units at the time. You can refer to Enterprise Address System addresses with units for a partial list. |
