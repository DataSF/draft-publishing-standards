...
![](../../.gitbook/assets/address_numbers.png)
...
* Each address corresponds to an entrance from the street
  ...
  * Numbers can be assigned where there is no building, but they must be associated [with a parcel](https://github.com/datasf/draft-publishing-standards/tree/82f330786b72856ff25913ae7bcc31ca4b134a9f/basemap/assessor-parcel-numbers-apn.md)
